    ...
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div class="md:w-8/12 lg:w-6/12 px-5 flex flex-col items-center md:items-start md:justify-center py-10 md:py-10">
                ...
                @auth
                    @if ($user->id !== auth()->user()->id)
                        {{-- $user: usuario que estamos visitando
                          auth()->user: usuario que esta autenticado   --}}
                        ...
                        @else
                            <form action="{{ route('users.unfollow', $user)}}" method="POST">
                                ...
                                <input 
                                type="submit"
                                class="bg-red-600 text-white uppercase rounded-lg px-3 py-3 text-xs font-bold cursor-pointer"
